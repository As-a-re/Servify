      ...
      >
        <View style={styles.header}>
          ...
          <TouchableOpacity style={styles.profileButton}>
            <Image style={styles.profileImage} source={require('./images/gb.jpg')} />
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          {featuredServices.map((service) => (
            <TouchableOpacity key={service.id} style={styles.serviceCard}>
              <Image style={styles.serviceImage} source={require('./images/gb.jpg')} />
              {service.discount && (
          ...
          {featuredServices.map((service) => (
            <TouchableOpacity key={service.id} style={styles.trendingCard}>
              <View style={styles.trendingImageContainer}>
                <Image style={styles.trendingImage} source={require('./images/gb.jpg')} />
                <LinearGradient
